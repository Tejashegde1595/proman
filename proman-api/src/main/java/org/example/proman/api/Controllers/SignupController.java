...
import org.example.proman.service.Business.SingupBusinessService;
...
public class SignupController {
    ...
    @Autowired
    private SingupBusinessService singupBusinessService;
    ...
    public ResponseEntity<SignupUserResponse> signup(final SignupUserRequest signupUserRequest){
        ...
        final UserEntity createdUserEntity = singupBusinessService.signup(userEntity);
